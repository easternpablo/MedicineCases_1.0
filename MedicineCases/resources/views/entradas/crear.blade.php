        ...
        <form method="POST" action="{{ url('/entrada/nueva-entrada/submit') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input id="file-note" type="file" class="form-control-file border @error('file-note') is-invalid @enderror" name="file-note" value="{{ old('file-note') }}" autocomplete="file-note">
